...
/**
 * A base class for creating TextView. Applies font passed by {@link R.styleable#CruxTextView_font} attribute or uses values passed in
...
public class CruxTextView extends AppCompatTextView {
    ...
    public CruxTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CruxTextView(Context context, AttributeSet attrs, int defStyleAttr) {
